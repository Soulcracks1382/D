...
async def attack(update: Update, context: CallbackContext):
    ...
    args = context.args
    if len(args) != 3:
        await context.bot.send_message(chat_id=chat_id, text="*❌ Invalid command format ❌\n\n✅ Usage: /attack <Target_IP> <Target_Port> <Time_Duration>\n\n✅ Example: /attack 127.0.0 8080 120*", parse_mode='Markdown')
        return
    ...
    await context.bot.send_message(chat_id=chat_id, text=( 
        ...
        f"*📊 Api response*: `''status'': ''success'', ''message'': ''attack sent successfully''`"
    ), parse_mode='Markdown')
...
async def run_attack(chat_id, attack_command, context):
    try:
        ...
        await context.bot.send_message(chat_id=chat_id, text="*✅ Attack Completed! ✅*\n*Thank you for using our service!*\n*Send feedback must from the owner*", parse_mode='Markdown')
